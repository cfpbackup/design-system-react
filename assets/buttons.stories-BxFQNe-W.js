import{n as e}from"./chunk-DnJy8xQt.js";import{t}from"./jsx-runtime-BX9360Lk.js";import{D as n,E as r,O as i,t as a}from"./src-DQOBo5ax.js";import{t as o}from"./link-BTmiBjQm.js";var s,c,l,u,d,f,p,m,h,g,_,v,y,b,x,S;e((()=>{a(),n(),s=t(),{expect:c,fn:l,userEvent:u,within:d}=__STORYBOOK_MODULE_TEST__,f={title:`Components (Verified)/Buttons`,component:i,tags:[`autodocs`],argTypes:{appearance:{control:`select`},size:{control:`select`},disabled:{control:`boolean`}},parameters:{docs:{description:{component:`Buttons are interactive elements that signal actions. They should be used sparingly as each additional button on a page reduces the visual prominence of a call to action. In contrast, links should lead users to another page or further information.
