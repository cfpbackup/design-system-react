import{n as e}from"./chunk-BneVvdWh.js";import{t}from"./jsx-runtime-6sF1Ejqi.js";import{D as n,E as r,O as i,t as a}from"./src-CstevNHE.js";import{t as o}from"./link-BzSyxmCL.js";var s,c,l,u,d,f,p,m,h,g,_,v,y,b,x,S;e((()=>{a(),n(),s=t(),{expect:c,fn:l,userEvent:u,within:d}=__STORYBOOK_MODULE_TEST__,f={title:`Components (Verified)/Buttons`,component:i,tags:[`autodocs`],argTypes:{appearance:{control:`select`},size:{control:`select`},disabled:{control:`boolean`}},parameters:{docs:{description:{component:`Buttons are interactive elements that signal actions. They should be used sparingly as each additional button on a page reduces the visual prominence of a call to action. In contrast, links should lead users to another page or further information.
